...
{
    public List<MonsterBase> turnListMonsterBase;
    List<BattleMonsterTag.CharactorTag> turnListCharactorNumber;

    public List<MonsterBase> CreateTurn(List<MonsterBase> turnList)
    {
        this.turnListMonsterBase = turnList;
        QuickSort(0, turnList.Count - 1);
        turnListMonsterBase.Reverse();
